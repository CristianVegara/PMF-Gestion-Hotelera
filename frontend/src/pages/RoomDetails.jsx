...
const RoomDetails = () => {
    ...
    return (
        ...
        {activeBookingWithRoom != null && (
            <div
            className="active-room-client-card"
            onClick={() => navigate(`/clients/${activeBookingWithRoom.cliente.id}`)}>
            <div className="arc-title">Ocupada por: {activeBookingWithRoom.cliente.nombre}</div>                            
            </div>
        )}
